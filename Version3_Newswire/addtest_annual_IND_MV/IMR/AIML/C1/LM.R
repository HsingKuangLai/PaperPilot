...
for (RM_proxy in RM_proxies) {
  ...
  control_vars_AM <- c("POST","AIPOST","MLPOST","RPA","POST_RPA","LEV","OCF","MTB","MS","INST","CYCLE","NOA","ZSCORE","CL", "ADJROA", "ADJROA_sq","SIZE","BIG4","YEAR")
  control_vars_RM <- c("POST","AIPOST","MLPOST","RPA","POST_RPA","LEV","OCF","MTB","MS","INST","CYCLE","NOA","ZSCORE","CL", "MTB", "ADJROA", "ADJROA_sq", "SIZE", "ADV","RD","YEAR")

...
for (RM_proxy in RM_proxies) {
  ...
  glht_mod_AM <- glht(model = modelAM, linfct = c("AIPOST1 + AIPOST_RPA1 = 0"))
  print(RM_proxy)
  print(summary(glht_mod_AM))
  glht_mod_RM <- glht(model = modelRM, linfct = c("AIPOST1 +AIPOST_RPA1 = 0"))
  print(summary(glht_mod_RM))
  
  glht_mod_AM <- glht(model = modelAM, linfct = c("MLPOST1 + MLPOST_RPA1 = 0"))
  print(RM_proxy)
  print(summary(glht_mod_AM))
  glht_mod_RM <- glht(model = modelRM, linfct = c("MLPOST1 +MLPOST_RPA1 = 0"))
  print(summary(glht_mod_RM))
  sink()

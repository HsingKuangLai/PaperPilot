...
sink("Result_NICtd_withControlGroup.txt")
...
RM_proxy <- "RM2"      # Substitute 'RM' with any other RM proxy as needed
...
modelRM_HAT_formula <- as.formula(paste(RM_proxy, "~ RPA_Ctd  + ", paste(control_vars_RM, collapse=" + ")))
